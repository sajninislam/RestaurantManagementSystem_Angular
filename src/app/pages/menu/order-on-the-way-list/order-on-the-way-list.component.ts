...
@Component({
  selector: 'app-order-on-the-way-list',
  templateUrl: './order-on-the-way-list.component.html',
  styleUrls: ['./order-on-the-way-list.component.css']
})
export class OrderOnTheWayListComponent implements OnInit{
  ...
  ngOnInit(): void {
    this.gerOrderServise.getOrder('OnTheWay').subscribe((res:any)=>{
      this.form = res;    
