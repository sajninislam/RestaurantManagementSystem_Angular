...
@Component({
  selector: 'app-viewhomebranch',
  templateUrl: './viewhomebranch.component.html',
  styleUrls: ['./viewhomebranch.component.css']
})
export class ViewhomebranchComponent implements OnInit{
